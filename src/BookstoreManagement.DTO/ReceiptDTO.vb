Public Class ReceiptDTO
	...
	Private _deptBeforeCollect As Integer
	...
	Property DeptBeforeCollect() As Integer
		Get
			Return _deptBeforeCollect
		End Get
		Set(ByVal Value As Integer)
			_deptBeforeCollect = Value
		End Set
	End Property
